...
# MIDI processed
def process_midi():
    midi_folder_path = "../all_data/data/midi"
    processed_folder_path = "../all_data/data/classic_music/processed_midi"
...
# MIDI to PDF
def midi2pdf():
    midi_folder_path = "../all_data/data/classic_music/processed_midi"
    ...
    for root, dirs, files in os.walk(midi_folder_path):
        for folder in dirs:
            ...
            for file in os.listdir(os.path.join(root, folder)):
                ...
                output_sheet_file = active_pdf_folder + "/" + file + ".png"
                print(output_sheet_file)
...
def midi2jpg():
    midi_folder_path = "../all_data/data/classic_music/processed_midi"
    pdf_folder_path = "../all_data/data/images"
